"""Integration tests for CLI impl command (requires git subprocess)."""
...
class TestImplWithConfig:
    def test_allocates_slot(
        ...
        with (
            ...
            patch("devops_ai.cli.impl.update_slot_status"),
            patch("devops_ai.cli.impl.REGISTRY_PATH", tmp_path / "registry.json"),
